To Run License Service You need the following requirements:

1.Install and setup MysqL Server according to the Handouts Chapter 4
...
2.Install MySQL Connector from https://dev.mysql.com/downloads/connector/net/
